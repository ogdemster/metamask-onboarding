...
})({"ekll7":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "49d58b121959ee5a";
"use strict";
...
const updateButton = ()=>{
    if (!(0, _onboardingDefault.default).isMetaMaskInstalled()) {
        ...
        onboardButton.onclick = async ()=>{
            try {
                const result = await (0, _writeToTheContractDefault.default)("Hello World! 0x", accounts);
                console.log(result);
                if (result.code === 4001) alert("User rejected transaction");
                else if (result.code !== 0) alert(`Transaction failed with error code: ${result.code}`);
            } catch (error) {
        ...
        if (sendEthButton) sendEthDiv.removeChild(sendEthButton);
    }
};
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    if ((0, _onboardingDefault.default).isMetaMaskInstalled()) {
        window.ethereum.request({
            ...
            accounts = accs;
            if (accounts.length > 0) accSpan.innerHTML = accounts[0];
            updateButton();
        });
        window.ethereum.on("accountsChanged", (newAccounts)=>{
            accounts = newAccounts;
            if (accounts.length > 0) accSpan.innerHTML = accounts[0];
            else accSpan.innerHTML = "";
            updateButton();
        });
    }
});

},{"@metamask/onboarding":"gSj9U","./writeToTheContract":"k7xhB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gSj9U":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"k7xhB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const contract = new web3.eth.Contract((0, _indexJs.abi), (0, _indexJs.NFT_CONTRACT_ADDRESS));
async function writeValue(newValue, accounts) {
    const result = await contract.methods.writeNewHello(newValue).send({
        from: accounts[0]
...
// writeValue();
exports.default = writeValue;

},{"web3":"caAX1","../constants/index.js":"kuLm8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ekll7","8dyI3"], "8dyI3", "parcelRequire56d0")

//# sourceMappingURL=index.1959ee5a.js.map
